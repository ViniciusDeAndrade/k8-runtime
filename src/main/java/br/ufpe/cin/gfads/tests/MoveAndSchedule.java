...
public class MoveAndSchedule {
	public static void main(String[] args) throws Exception {
		...
		//filename
		String fileName = "pure-two-replicas-nginx.csv";
		int replicas = 1;
		...
		services[0] = "nginx-pure1";
		services[1] = "nginx-pure2";
		services[2] = "nginx-pure3";
		services[3] = "nginx-pure4";
		services[4] = "nginx-pure5";
		...
		*/
		...
		for(int index = 0 ; index < n ; index++) {
			for(int j = 0; j < services.length; j++) {
				...
				System.out.println("TTM = "+finish/1000000 + " line = " + line + " service = " + serv );
